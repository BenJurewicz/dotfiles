# Generated by Powerlevel10k configuration wizard on 2025-01-15 at 14:17 CET.
...
() {
  ...
  function prompt_heart_icon() {
    # p10k segment -b 5 -f 255 -i '❤️'
    p10k segment -b 5 -f 255 -i '❤'
  }

  function instant_prompt_heart_icon() {
      prompt_heart_icon
  }
